...
modules = [
    ...
    'pyfr.solvers.mceuler.kernels.multicomp',
    'pyfr.solvers.mceuler.kernels.multicomp.chem',
    'pyfr.solvers.mceuler.kernels.multicomp.cpg',
    'pyfr.solvers.mceuler.kernels.multicomp.tpg',
    ...
    'pyfr.solvers.mcnavstokes.kernels.multicomp',
    'pyfr.solvers.mcnavstokes.kernels.multicomp.cpg',
    'pyfr.solvers.mcnavstokes.kernels.multicomp.tpg',
...
package_data = {
    ...
    'pyfr.solvers.mceuler.kernels.multicomp.chem': ['*.mako'],
    'pyfr.solvers.mceuler.kernels.multicomp.tpg': ['*.mako'],
    'pyfr.solvers.mceuler.kernels.multicomp.cpg': ['*.mako'],
